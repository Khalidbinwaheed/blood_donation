...
String _$loadDoctorsByCenterHash() =>
    r'12c7d30192342ef586e873614474d174b5092cba';

/// See also [loadDoctorsByCenter].
@ProviderFor(loadDoctorsByCenter)
const loadDoctorsByCenterProvider = LoadDoctorsByCenterFamily();

/// See also [loadDoctorsByCenter].
class LoadDoctorsByCenterFamily extends Family<AsyncValue<List<AppUser>>> {
  /// See also [loadDoctorsByCenter].
  const LoadDoctorsByCenterFamily();

  /// See also [loadDoctorsByCenter].
  LoadDoctorsByCenterProvider call(
    String centerId,
  ) {
    return LoadDoctorsByCenterProvider(
      centerId,
    );
  }

  @override
  LoadDoctorsByCenterProvider getProviderOverride(
    covariant LoadDoctorsByCenterProvider provider,
  ) {
    return call(
      provider.centerId,
    );
  ...
  @override
  String? get name => r'loadDoctorsByCenterProvider';
}

/// See also [loadDoctorsByCenter].
class LoadDoctorsByCenterProvider
    extends AutoDisposeStreamProvider<List<AppUser>> {
  /// See also [loadDoctorsByCenter].
  LoadDoctorsByCenterProvider(
    String centerId,
  ) : this._internal(
          (ref) => loadDoctorsByCenter(
            ref as LoadDoctorsByCenterRef,
            centerId,
          ),
          from: loadDoctorsByCenterProvider,
          name: r'loadDoctorsByCenterProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$loadDoctorsByCenterHash,
          dependencies: LoadDoctorsByCenterFamily._dependencies,
          allTransitiveDependencies:
              LoadDoctorsByCenterFamily._allTransitiveDependencies,
          centerId: centerId,
        );

  LoadDoctorsByCenterProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    Stream<List<AppUser>> Function(LoadDoctorsByCenterRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: LoadDoctorsByCenterProvider._internal(
        (ref) => create(ref as LoadDoctorsByCenterRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeStreamProviderElement<List<AppUser>> createElement() {
    return _LoadDoctorsByCenterProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is LoadDoctorsByCenterProvider && other.centerId == centerId;
  }

  @override
  int get hashCode {
    var hash = _SystemHash.combine(0, runtimeType.hashCode);
    hash = _SystemHash.combine(hash, centerId.hashCode);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin LoadDoctorsByCenterRef on AutoDisposeStreamProviderRef<List<AppUser>> {
  /// The parameter `centerId` of this provider.
  String get centerId;
}

class _LoadDoctorsByCenterProviderElement
    extends AutoDisposeStreamProviderElement<List<AppUser>>
    with LoadDoctorsByCenterRef {
  _LoadDoctorsByCenterProviderElement(super.provider);

  @override
  String get centerId => (origin as LoadDoctorsByCenterProvider).centerId;
}

String _$loadAllUsersHash() => r'5438223c2a032ed7a89658db18bec2c29cd84510';

/// See also [loadAllUsers].
@ProviderFor(loadAllUsers)
final loadAllUsersProvider = AutoDisposeStreamProvider<List<AppUser>>.internal(
  loadAllUsers,
  name: r'loadAllUsersProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$loadAllUsersHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef LoadAllUsersRef = AutoDisposeStreamProviderRef<List<AppUser>>;
